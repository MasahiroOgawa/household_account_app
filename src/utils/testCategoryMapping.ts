...
const testCases = [
  ...
  // Special cases - transfers that should NOT be kids
  {
    oldCategory: 'Bank Transfer',
    description: '振込 楽天証券',
    shopName: '楽天証券',
    amount: 50000,
    source: 'UFJ Bank',
    expected: 'others' // Investment, not kids
  },
  {
    oldCategory: 'E-Money Transfer',
    description: 'PayPay チャージ',
    shopName: 'PayPay',
    amount: 10000,
    source: 'UFJ Bank',
    expected: 'others' // E-money, not kids
  }
];
