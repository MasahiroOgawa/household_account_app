    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-black text-sm">Select or drag CSV files to upload</p>
          <p className="text-black text-xs">Drag and drop CSV files here or click the upload button above</p>
          <input
            type="file"
            accept=".csv"
            multiple
